      ...
      if (action === 'add') {
        await getRemoteHowRareData(collectionstring).then(async thisdata => {
          if (thisdata.result.api_code === 200) {
            ...
            var querystring = 'INSERT INTO howraredata( collection_ID, data, created_on, last_updated ) VALUES ( $1,$2,to_timestamp($3 / 1000.0),to_timestamp($4 / 1000.0) ) ON CONFLICT ON CONSTRAINT collection_ID DO NOTHING'
