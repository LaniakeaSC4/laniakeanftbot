...
async function getSupportedServers() {
  return new Promise((resolve, reject) => {
    ...
    var querystring = "SELECT serverid,raresnipes,epicsnipes,legendarysnipes,mythicsnipes,homechannel_enabled,homechannel_id,homechannel_collections,premium,inserver, alpha_channels,singlefeedmode,rare_enabled, epic_enabled, legendary_enabled, mythic_enabled FROM servers"
